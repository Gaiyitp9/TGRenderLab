...
std::unordered_map<LCH::KeyCode, wchar_t const*> LCH::InputEventInfo::keysName =
{
...
std::unordered_map<LCH::InputEvent::Type, wchar_t const*> LCH::InputEventInfo::eventTypes =
{
